        ...
        for (const r of orderedIntervalsSqlRows) {
            if (r.c === 1) {
                ...
                if (r.m === 0) {
                    ...
                    throw new Error(`CODE00000231 Invalid row in intervalsSqlRowsToIntervals. Use correct sql!`);
                }
            } else {
                throw new Error(`CODE00000232 Invalid row in intervalsSqlRowsToIntervals. Use correct sql!`);
            }
        }
    }
